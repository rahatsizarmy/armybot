...
module.exports = client => {
  console.log(`[${moment().format('YYYY-MM-DD HH:mm:ss')}] BOT: Tüm komutlar başarıyla yüklendi`);
  console.log(`[${moment().format('YYYY-MM-DD HH:mm:ss')}] BOT: ${client.user.username} ismi ile giriş yapıldı!`);
  client.user.setPresence ({ game: { name: `${prefix}yardım | ${client.guilds.size} sunucu | V11.3.2`, url: 'https://www.twitch.tv/batumurt1', type: 0 } });
